...
import GreenHash from "../model/GreenHash";
import YellowCollection from "../model/YellowCollection";
...
describe("EncryptedWord Functionality", () => {
  it("should correctly encode to Base64Url and decode back to the original object", () => {
    ...
    ).toEqual(originalGreenHashes.map((h) => h.hash.toString(32)));
    expect(
